...
public class PatientChildData implements Parcelable {
    ...
    public static Creator<PatientChildData> getCreator() {
        return CREATOR;
    }

    public PatientChildData() {
        patientObjectId = "";
        firtname = "";
        middlename = "";
        lastname = "";
    ...
    public PatientChildData(Parcel in) {
...
// ------------ FROM USERS
    ...
    public static final Creator<PatientChildData> CREATOR = new Creator<PatientChildData>()
    {
        public PatientChildData createFromParcel(Parcel in)
        {
            return new PatientChildData(in);
        }
        public PatientChildData[] newArray(int size)
        {
            return new PatientChildData[size];
        }
    };
